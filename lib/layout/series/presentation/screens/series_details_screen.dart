...
import '../controller/series_details_bloc.dart';
import '../controller/series_details_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<SeriesDetailsBloc>()
        ...
        ..add(GetSeriesRecommendationEvent(id)),
      lazy: false,
      child:  Scaffold(
                        ...
                        child: ShaderMask(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: ApiConstants.imageUrl(
                                state.seriesDetails!.backDropPath),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    state.seriesDetails!.firstAirDate.split('-')[0],
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '${state.seriesDetails!.voteAverage}',
                                      style: const TextStyle(
                                        fontSize: 16.0,
                                        fontWeight: FontWeight.w500,
                                        letterSpacing: 1.2,
                                ...
                                const SizedBox(width: 16.0),
                                Text(
                                '${state.seriesDetails!.numberOfSeasons} seasons',
                                  style: const TextStyle(
                                    fontSize: 16.0,
                                    fontWeight: FontWeight.w500,
                                    letterSpacing: 1.2,
                            ...
                            const SizedBox(height: 8.0),
                            Text(
                              'Genres: ${_showGenres(state.seriesDetails!.genres)}',
                              style: const TextStyle(
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (BuildContext context) =>
                                SeriesDetailScreen(id: recommendation.id)),
                      );
                    },
                    child: CachedNetworkImage(
                      imageUrl: ApiConstants.imageUrl(
